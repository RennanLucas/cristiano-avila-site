    ...
    <section className="py-24 lg:py-32 bg-black text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center relative z-10 space-y-8">
        ...
        >
          ...
          <h2 className="tracking-tight text-3xl sm:text-4xl lg:text-5xl text-white tracking-tight leading-[1.18]">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 bg-white text-black px-8 py-4 rounded-full text-sm font-semibold hover:bg-zinc-100 transition-colors"
          >
