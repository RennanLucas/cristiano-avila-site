    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <div className="hidden sm:block bg-white text-[#18363B] text-xs font-semibold py-2 px-3.5 rounded-full shadow-luxury border border-[#18363B]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
          ...
          >
            {/* Ping indicator */}
            <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-[#B7925A] rounded-full border-2 border-white" />
