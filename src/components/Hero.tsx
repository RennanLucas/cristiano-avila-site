        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid items-center gap-10 sm:gap-12 lg:grid-cols-[1.02fr_.98fr] lg:gap-16">
            <div className="max-w-3xl">
              <div className="mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-white/80 bg-white/72 px-3.5 py-1.5 text-[10px] font-medium text-zinc-700 shadow-[0_10px_32px_rgba(0,0,0,0.07)] sm:mb-7 sm:text-xs md:backdrop-blur-xl">
            ...
            <div className="relative mx-auto w-full max-w-[500px] lg:max-w-[540px]">
              <div className="relative">
                ...
                <div className="relative aspect-[4/5] overflow-hidden rounded-[2rem] border border-white/80 bg-zinc-100 shadow-[0_30px_80px_rgba(0,0,0,0.14)] ring-1 ring-black/[0.04] sm:rounded-[2.35rem] sm:shadow-[0_38px_100px_rgba(0,0,0,0.16)]">
                  <Image src={CLINIC_CONTACT.avatarUrl} alt="Cristiano Ávila da Silva, psicólogo" fill sizes="(max-width: 639px) calc(100vw - 32px), (max-width: 1023px) 500px, 540px" className="object-cover object-top transition-transform duration-[900ms] md:hover:scale-[1.02]" priority />
          ...
          <div className="mt-12 sm:mt-16"><TrustBadges /></div>
        </div>
      </section>
    </HeroVideoBackground>
  );
