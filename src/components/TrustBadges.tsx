...
export default function TrustBadges() {
  return (
    <section className="bg-white px-4 sm:px-6 pb-10 sm:pb-14">
      <div className="max-w-6xl mx-auto">
        <div className="relative overflow-hidden rounded-[28px] border border-zinc-200/90 bg-white shadow-[0_18px_55px_rgba(0,0,0,0.08)]">
          ...
          <div className="grid gap-7 px-6 py-7 sm:px-9 lg:grid-cols-[1.7fr_1fr] lg:items-center lg:gap-10">
            <div className="flex min-w-0 items-center gap-4 sm:gap-5">
              <div className="relative shrink-0">
                <Image
                  ...
                  width={84}
                  height={84}
                  className="h-[72px] w-[72px] sm:h-[82px] sm:w-[82px] rounded-[20px] object-cover object-top shadow-sm"
                />
                <span
            ...
            <div className="grid grid-cols-3 border-t border-zinc-200 pt-5 lg:border-l lg:border-t-0 lg:pl-9 lg:pt-0">
              ...
              <div className="border-l border-zinc-200 pl-3 sm:pl-5">
                ...
                <strong className="mt-1 block text-sm sm:text-lg font-bold text-black">Presencial & Online</strong>
              </div>
            </div>
          </div>
        </div>
