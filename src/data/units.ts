...
export const CURRENT_UNITS: CurrentUnit[] = [
  ...
  },
  {
    ...
    zip: "12942-540",
    availability: "Atendimento com hora marcada",
    tagline: "Unidade presencial em Alvinópolis, Atibaia.",
  ...
  },
  {
    ...
    state: "SP",
    title: "Clínica Mind & Life São Bernardo do Campo",
    address: "Rua José Versolato, 111",
    complement: "Torre B • sala 707",
    neighborhood: "Centro",
    zip: "09750-730",
    availability: "Atendimento com hora marcada",
    tagline: "Unidade presencial no centro de São Bernardo do Campo.",
  ...
  },
  {
    ...
    city: "Santos",
    state: "SP",
    title: "Clínica Mind & Life Santos",
    address: "Avenida Conselheiro Nébias, 756",
    complement: "11º andar • conjunto 1106",
    neighborhood: "Boqueirão",
    zip: "11045-002",
    availability: "Atendimento com hora marcada",
    tagline: "Unidade presencial no bairro Boqueirão, em Santos.",
